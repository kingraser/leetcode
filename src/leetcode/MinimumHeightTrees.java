...
public class MinimumHeightTrees {
    ...
    */
    ...
    @Test
    public void test() {
        Assert.assertEquals(new ArrayList<>(), findMinHeightTrees(0, new int[][] {}));
        Assert.assertEquals(Arrays.asList(0), findMinHeightTrees(1, new int[][] { { 0, 0 } }));
        Assert.assertEquals(Arrays.asList(1), findMinHeightTrees(4, new int[][] { { 1, 0 }, { 1, 2 }, { 1, 3 } }));
        Assert.assertEquals(new HashSet<>(Arrays.asList(3, 4)),
