	...
	*/
	...
	public void test() {
		TestUtil.testEquals(new Object[][]{
				{5d, TestUtil.getArray("[[1,2],[2,5],[4,3]]")},
				{3.25d, TestUtil.getArray("[[5,2],[5,4],[10,3],[20,1]]")},
		});
	}
	...
	public double averageWaitingTime(int[][] customers) {
		...
		for (int[] customer : customers)
			totalWaitingTime += (currentTime = Math.max(currentTime, customer[0]) + customer[1]) - customer[0];
