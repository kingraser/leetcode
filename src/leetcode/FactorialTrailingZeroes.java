...
public class FactorialTrailingZeroes {
  ...
  The idea is:
      ...
      3 And we need to account for all the products of 5 and 2, likes 4 X 5 = 20 ...
      4 So, if we take all the numbers with 5 as a factor, we'll have more than enough even numbers to pair with them to get factors of 10
  ...
  Example Two
      ...
      but wait, actually 25 is 5 X 5, so each multiple of 25 has an extra factor of 5,
      e.g. 25 X 4 = 100 which introduces extra of zero.
      ...
      The above example tell us, we need care about 5, 5 X 5, 5 X 5 X 5, 5 X 5 X 5 X 5 ....
