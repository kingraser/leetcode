...
public class BaseballGame {
  ...
  */
  ...
  public int calPoints(String[] ops) {
    ...
    for (String s : ops)
      if ("C".equals(s)) points.pollLast();
      else if ("D".equals(s)) points.addLast(points.peekLast() << 1);
      else if ("+".equals(s)) {
        int last = points.pollLast(), value = last + points.peekLast();
        points.addLast(last);
        points.addLast(value);
      } else points.addLast(Integer.parseInt(s));
