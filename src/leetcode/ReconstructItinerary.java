...
//--------------------- Change Logs----------------------
//@author wangwenlong Initial Created at 2016年2月15日;
//-------------------------------------------------------
public class ReconstructItinerary {
    ...
    */
    ...
    @Test
    public void test() {
        Assert.assertEquals(Arrays.asList("JFK", "MUC", "LHR", "SFO", "SJC"), findItinerary(
                new String[][] { { "MUC", "LHR" }, { "JFK", "MUC" }, { "SFO", "SJC" }, { "LHR", "SFO" } }));
        Assert.assertEquals(Arrays.asList("JFK", "ATL", "JFK", "SFO", "ATL", "SFO"), findItinerary(new String[][] {
                { "JFK", "SFO" }, { "JFK", "ATL" }, { "SFO", "ATL" }, { "ATL", "JFK" }, { "ATL", "SFO" } }));
        Assert.assertEquals(Arrays.asList("JFK", "NRT", "JFK", "KUL"),
