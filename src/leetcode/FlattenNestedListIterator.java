...
public class FlattenNestedListIterator {
    ...
    */
    ...
    @Test
    public void test() {
        Assert.assertEquals(Arrays.asList(1, 1, 2, 1, 1),
        ...
        Assert.assertEquals(Arrays.asList(1, 4, 6),
                Lists.newArrayList(new NestedIterator(Arrays.asList(new NestedInteger(1), new NestedInteger(Arrays
                        .asList(new NestedInteger(4), new NestedInteger(Arrays.asList(new NestedInteger(6)))))))));
    }
