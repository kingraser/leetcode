...
public class DesignAFoodRatingSystem {
	...
	*/
	@Test
	public void test() {
		TestUtil.testEquals(new FoodRatings(new String[]{"kimchi", "miso", "sushi", "moussaka", "ramen", "bulgogi"},
						new String[]{"korean", "japanese", "japanese", "greek", "japanese", "korean"},
						new int[]{9, 12, 8, 15, 14, 7}),
				new String[]{"highestRated", "highestRated", "changeRating", "highestRated", "changeRating", "highestRated"},
				new Object[]{"kimchi", "ramen", null, "sushi", null, "ramen"},
				TestUtil.getInputs("[[\"korean\"], [\"japanese\"], [\"sushi\", 16], [\"japanese\"], [\"ramen\", 16], [\"japanese\"]]"));
	}
	...
	public class FoodRatings {
		...
		public FoodRatings(String[] foods, String[] cuisines, int[] ratings) {
			for (int i = 0; i < foods.length; i++) {
				...
				cuisineMap.computeIfAbsent(cuisines[i],
